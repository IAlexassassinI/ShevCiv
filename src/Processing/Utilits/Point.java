...
public class Point implements Serializable {
    ...
    final public static int CENTER_NUM = 0;
    final public static int TOP_NUM = 1;
    final public static int TOP_RIGHT_NUM = 2;
    final public static int RIGHT_NUM = 3;
    final public static int BOTTOM_RIGHT_NUM = 4;
    final public static int BOTTOM_NUM = 5;
    final public static int BOTTOM_LEFT_NUM = 6;
    final public static int LEFT_NUM = 7;
    final public static int TOP_LEFT_NUM = 8;
