...
public class TypeOfFlora extends TileLayer implements Serializable {
    ...
    TypeOfFlora(String modElementName, int additionalActionPointCost, int additionalVision, BattleModifier battleModifier, Wealth wealth, WhereCanBe whereCanExist){
