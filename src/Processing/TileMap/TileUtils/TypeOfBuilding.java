...
public class TypeOfBuilding extends TileLayer implements Serializable {
    ...
    TypeOfBuilding(String modElementName,  boolean destroyFlora, int additionalActionPointCost, int additionalVision, BattleModifier battleModifier, Wealth wealth, WhereCanBe whereCanExist){
